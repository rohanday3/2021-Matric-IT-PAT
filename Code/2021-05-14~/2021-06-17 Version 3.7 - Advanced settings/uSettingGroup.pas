...
constructor TSettingGroup.Create(AOwner, AParent: TFmxObject);
begin
...
procedure TSettingGroup.resize;
begin
  try
...
procedure TSettingGroup.setColor(Color: TAlphaColor);
begin
  opanel.Fill.Color := Color;
end;

procedure TSettingGroup.SetLabelDesc(caption: string);
begin
  olabelDesc.Text := caption;
end;

procedure TSettingGroup.SetLabelName(caption: string);
begin
  olabelName.Text := caption;
end;

procedure TSettingGroup.SetLabelQuantity(caption: string);
begin
  olabelQuantity.Text := caption;
end;

procedure TSettingGroup.SetLabelTime(caption: string);
begin
