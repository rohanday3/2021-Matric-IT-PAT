...
uses
  ...
  System.StrUtils, winApi.Windows, FMX.Platform, uResizeThread;
...
var
tResize:ResizeThread;
begin
tResize:=ResizeThread.Create;
end;
...
begin
  ...
  pnlSettingsGroups.Height := ClientHeight - pnlTop.Height -
