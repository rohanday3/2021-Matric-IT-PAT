...
begin
  ...
  tContrMain.Width := Self.Width - MultiView1.Width;
  tContrMain.Height := Self.Height - pnlTop.Height - rectCopyright.Height;
  rectCopyright.Width := Self.Width - MultiView1.Width;
  flowHome.Width := Self.Width - MultiView1.Width;
  flowHome.Height := Self.Height;
  imgAccount.Position.X := Self.Width - imgAccount.Width -
    MultiView1.Width - 10;
  lblAccount.Position.X := Self.Width - imgAccount.Width - lblAccount.Width -
    MultiView1.Width - 25;
  lblDatetime.Width := Self.Width - imgAccount.Width - lblAccount.Width -
    MultiView1.Width - 80 - lblDatetime.Width;
  lblDatetime.Position.X := lblTab.Width + MultiView1.Width;

  // Tab Donations
  StringGrid1.Width := Self.Width - MultiView1.Width;
  ...
  lblNoRecords.Position.Y := pnlDonationQuery.Height + StringGrid1.Height / 2 +
    pnlTop.Height;
  StringGrid1.Height := Self.Height - pnlDonationQuery.Height;
  pnlDonationQuery.Width := Self.Width - MultiView1.Width;
  rectSearch.Position.X := pnlDonationQuery.Width - rectSearch.Width;
